...
<div class="container">
    ...
    <div class="form-horizontal" role="form">
        <div class="form-group col-sm-12">
            ...
            <button id="add" class="btn btn-info" data-toggle="modal" data-target="#addDoctorModal">添加</button>
   ...
   <%-- <div>
    ...
    <div class="modal fade"  id="addDoctorModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <font>女</font><input type="radio" name="sex"  value="女"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <font>男</font><input type="radio" name="sex"   value="男"/>
                    </p>
                    <p>
                    ...
                    <div id="addDocyorTips2" style="display: none;"><font id="fontTips" style="color: red">请输入完整的数据</font></div>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭
                    </button>
                    <button type="button"  onclick="addDoctor()" class="btn btn-primary">
                        确认
                    </button>
                </div>
            </div><!-- /.modal-content -->
        ...
        <script>
            function addDoctor(){
                ...
                if(name.length==0||title.length==0||sex.length==0||departmentId.length==0){
                    $("#addDocyorTips2").show();
                        return ;
                    ...
                    $.ajax({
                       url:"/doctor/add",
                        type:"POST",
                        dataType:"JSON",
                        data:{name:name,title:title,sex:sex,departmentId:departmentId},
                   ...
                   /* function add(){
                    ...
                    var id = $("input[name='id']").val()
                        ...
                        $.ajax({
                            ...
                            type: "POST",
                            dataType: "json",
                            data: {type:"doctor",id:id,name:"active"},
                            success: function (data) {
                                query();
                            },
                            error:function(){
                ...
                <script>
                    ...
                    function deleteById(){
                        ...
                        $.ajax({
                            ...
                            type: "POST",
                            dataType: "json",
                            data: {type:"doctor",id:id,name:"disable"},
                            success: function (data) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var item of data.datas) {
                        ...
                        $template.children('td').eq(1).text(item.name==null?"":item.name);
                        $template.children('td').eq(2).text(item.sex==null?"":item.sex);
                        $template.children('td').eq(3).text(item.departmentName==null?"":item.departmentName);
                        $template.children('td').eq(4).text(item.pwd==null?"未激活":"已激活");
