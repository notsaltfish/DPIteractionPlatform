...
<div class="row">
    <div class="col-sm-12">
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" style="height: 30px" placeholder="用户名"  name="name"value="${user.name}"  class="input-xlarge">
                <div id="nameTips" style="display: none;"><font style="color: red">用户名不能为空</font></div>
            </div>
        </div>
    </div>
    <div class="col-sm-12">
...
$("input[name='oldPwd']").blur(function () {
    $.ajax({
        ...
        type:"POST",
        dataType:"json",
        data:{pwd:$("input[name='oldPwd']").val()},
