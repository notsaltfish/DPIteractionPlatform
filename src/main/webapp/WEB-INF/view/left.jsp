...
<c:if test="${role!='admin'}">
	...
	<c:if test="${role=='doctor'}">
		...
		<c:if test="${role=='patient'}">
			<dl class="app">
				<dt onClick="changeImage()">指导用药<img src="/images/left/select_xl01.png"></dt>
				<dd><a href="/patient/tomediceinstruct" target="mainFrame">指导用药</a></dd>
				<!--	<dd><a href="#">接口类型管理</a></dd>-->
			</dl>
		</c:if>
...
$(".leftsidebar_box dt").css({"background-color":"#5a9ad9"});
